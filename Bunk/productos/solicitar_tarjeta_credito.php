...
<html>
    ...
    <body>
        ...
        <?php 
            ...
            $sql = "SELECT ca.id AS id_cuenta_ahorro, (SELECT nombre FROM BANCOS WHERE id=ca.id) AS nombre_banco
                    FROM CUENTAS_AHORRO ca, CLIENTES c 
                    WHERE c.id=$cliente_id AND c.id=ca.cliente_id";
            ...
            if($_SERVER['REQUEST_METHOD'] == 'POST'){
                ...
                if (isset($_POST['solicitar_tarjeta_credito'])){
                    ...
                    if (mysqli_query($con, $sql)) {
                        echo "Se ha solicitado una tarjeta de crédito que este asociada a la cuenta de ahorro $cuenta_ahorro_id abierta en el banco $nombre_banco.</br>";
